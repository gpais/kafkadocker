...
echo "security.inter.broker.protocol="${INTER_BROKER_PROTOCOL} >> /config/server.properties
echo "sasl.mechanism.inter.broker.protocol="${SASL_MECHANISM_INTER_BROKER} >> /config/server.properties
